...
abstract contract AcrossBridgeHookSharedParity is Test {
...
contract AcrossBridgeHookLegacyParityTest is AcrossBridgeHookSharedParity {
...
contract AcrossBridgeHookV2ParityTest is AcrossBridgeHookSharedParity {
    event AcrossBridgeInitiated(
        bytes32 indexed intentHash,
        uint256 destinationChainId,
        bytes32 outputToken,
