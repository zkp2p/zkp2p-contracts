...
| orchestratorV2 | `test/orchestratorV2/orchestratorV2.legacyCoverage.spec.ts` | `test-foundry/integration/OrchestratorV2LegacyCoverage.t.sol` | Mapped | Planned split: hooks and manual release, fulfill and cleanup, and signal-validation / gating coverage |
