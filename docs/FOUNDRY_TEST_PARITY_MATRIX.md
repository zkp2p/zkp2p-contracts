...
| escrowV2 | `test/escrowV2/escrowV2.oracleRates.spec.ts` | `test-foundry/integration/EscrowV2OracleRates.t.sol` | Mapped | Planned as a self-contained oracle-rate suite covering inline config, single and batch setters, deactivation, and unsupported tuple checks |
