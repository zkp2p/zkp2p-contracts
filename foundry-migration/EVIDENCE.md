...
| OrchestratorV2 delegated rates and manager fees | 4 | 4 | Every test passed individually; complete file 4/4, 0 skipped; cumulative deterministic suite 151/151, warm real 0.22s | Independently verified with real EscrowV2, delegated RateManager, signal-time fee snapshot, exact custom-error arguments, fulfillment, and token accounting |
