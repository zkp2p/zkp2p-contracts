...
const orchestratorLegacyFulfillHookFile = "test-foundry/deterministic/orchestrator/OrchestratorFulfillHookParity.t.sol";
const orchestratorLegacyFulfillPartialReentryFile = "test-foundry/deterministic/orchestrator/OrchestratorFulfillPartialReentryParity.t.sol";
const orchestratorLegacyManualReleaseFile = "test-foundry/deterministic/orchestrator/OrchestratorManualReleaseParity.t.sol";
...
const legacyZelleRemovalDeploymentFile = "test-foundry/deterministic/deployment/LegacyZelleRemovalDeploymentParity.t.sol";
...
const orchestratorLegacyDestinations = [
    ...
    ...[
        "test_FulfillHookRoutesFundsToTargetInsteadOfIntentRecipient",
        "test_FulfillHookEmitsHookAsFundsRecipient",
        "test_FulfillHookResetsApprovalToZero",
        "test_FulfillHookWithProtocolFeeConservesTransfers",
        "test_FulfillHookWithProtocolFeeEmitsNetAmount",
        "test_FulfillHookRejectsPartialPull",
        "test_FulfillHookRejectsUnexpectedBalanceIncrease",
    ].map((testName) => [orchestratorLegacyFulfillHookFile, "OrchestratorFulfillHookParityTest", testName]),
    ...[
        "test_FulfillPartialPaymentTransfersPartialRelease",
        "test_FulfillPartialPaymentReturnsUnusedLiquidity",
        "test_FulfillPartialPaymentEmitsPartialRelease",
        "test_FulfillPartialPaymentCalculatesFeeFromReleasedAmount",
        "test_FulfillReentrantHookBlocksNestedFulfillment",
        "test_FulfillReentrantHookCompletesOriginalFulfillment",
        "test_FulfillHookWithoutReentryExecutesNormally",
        "test_FulfillIntentRejectsWhenContractPaused",
    ].map((testName) => [orchestratorLegacyFulfillPartialReentryFile, "OrchestratorFulfillPartialReentryParityTest", testName]),
    ...[
        "test_ManualReleaseTransfersFullIntentAmountToPayer",
        "test_ManualReleaseDeletesIntentAndAccountIntent",
        "test_ManualReleaseUpdatesEscrowAccounting",
        "test_ManualReleaseEmitsIntentFulfilled",
        "test_ManualReleaseClosingDepositDeletesDeposit",
        "test_ManualReleaseClosingDepositDeletesPaymentMethodData",
        "test_ManualReleaseClosingDepositDeletesCurrencyData",
        "test_ManualReleaseClosingDepositEmitsDepositClosed",
        "test_ManualReleaseProtocolFeeTransfersCorrectAmounts",
        "test_ManualReleaseProtocolFeeEmitsNetAmount",
        "test_ManualReleaseReferrerFeeTransfersCorrectAmounts",
        "test_ManualReleaseReferrerFeeEmitsNetAmount",
        "test_ManualReleaseProtocolAndReferrerFeesTransferCorrectAmounts",
        "test_ManualReleaseProtocolAndReferrerFeesEmitNetAmount",
        "test_ManualReleaseRejectsMissingIntent",
        "test_ManualReleaseWithHookStillTransfersToIntentRecipient",
        "test_ManualReleaseWithHookAndFeeTransfersNetToIntentRecipient",
        "test_ManualReleaseWithHookAndFeeEmitsIntentRecipientAndNetAmount",
        "test_ManualReleaseRejectsNonDepositor",
    ].map((testName) => [orchestratorLegacyManualReleaseFile, "OrchestratorManualReleaseParityTest", testName]),
    ...[
        "test_PruneIntentsDeletesEveryIntent",
        "test_PruneIntentsRemovesEveryAccountIntent",
        "test_PruneIntentsEmitsForEveryIntent",
        "test_PruneIntentsSkipsZeroHashes",
        "test_PruneIntentsUnknownHashesDoNotRevert",
        "test_PruneIntentsUnknownHashesEmitNothing",
        "test_PruneIntentsFromWrongCallerSkipsWithoutEvents",
        "test_PruneIntentsUpdatesMultipleAccounts",
        "test_PruneIntentsEmptyArrayDoesNotRevert",
        "test_PruneIntentsEmptyArrayEmitsNothing",
    ].map((testName) => [orchestratorLegacyPruneFile, "OrchestratorPruneParityTest", testName]),
    ...[
        "test_SetEscrowRegistryUpdatesAddress",
        "test_SetEscrowRegistryEmitsUpdate",
        "test_SetEscrowRegistryRejectsNonOwner",
        "test_SetEscrowRegistryRejectsZeroAddress",
        "test_SetProtocolFeeUpdatesFee",
        "test_SetProtocolFeeEmitsUpdate",
        "test_SetProtocolFeeRejectsNonOwner",
        "test_SetProtocolFeeRejectsAboveMaximum",
        "test_SetProtocolFeeAcceptsMaximum",
        "test_SetProtocolFeeRecipientUpdatesRecipient",
        "test_SetProtocolFeeRecipientEmitsUpdate",
        "test_SetProtocolFeeRecipientRejectsZeroAddress",
        "test_SetProtocolFeeRecipientRejectsNonOwner",
        "test_SetPostIntentHookRegistryUpdatesRegistry",
        "test_SetPostIntentHookRegistryEmitsUpdate",
        "test_SetPostIntentHookRegistryRejectsZeroAddress",
        "test_SetPostIntentHookRegistryRejectsNonOwner",
        "test_SetRelayerRegistryUpdatesRegistry",
        "test_SetRelayerRegistryEmitsUpdate",
        "test_SetRelayerRegistryRejectsZeroAddress",
        "test_SetRelayerRegistryRejectsNonOwner",
        "test_SetAllowMultipleIntentsEnablesFlag",
        "test_SetAllowMultipleIntentsEmitsUpdate",
        "test_SetAllowMultipleIntentsDisablesFlag",
        "test_SetAllowMultipleIntentsRejectsNonOwner",
        "test_PauseOrchestratorSetsPaused",
        "test_PauseOrchestratorRejectsNonOwner",
        "test_UnpauseOrchestratorClearsPaused",
        "test_UnpauseOrchestratorRejectsNonOwner",
    ].map((testName) => [orchestratorLegacyGovernanceFile, "OrchestratorGovernanceParityTest", testName]),
    ...[
        "test_GetAccountIntentsReturnsEmptyArrayForAccountWithoutIntents",
        "test_GetAccountIntentsReturnsAllIntentsForAccount",
    ].map((testName) => [orchestratorLegacyViewsFile, "OrchestratorViewsParityTest", testName]),
];
if (orchestratorLegacySourceTests.length !== 141 || orchestratorLegacyDestinations.length !== 141) {
    throw new Error(
...
const riskManagerCoverageSource = "test/staking/riskManager.coverage.spec.ts";
const riskManagerCoverageSourceTests = inventory.tests.filter((test) => test.sourceFile === riskManagerCoverageSource);
const riskManagerCoverageDestinations = [
    ...[
        "test_RiskManagerConstructorRejectsZeroAndEoaDependencies",
        "test_RiskManagerGovernanceUpdatesVerifierPauseAndVaultController",
        "test_RiskManagerGovernanceRejectsNonOwnerAndInvalidVerifier",
        "test_RiskManagerConfigAcceptsDeferredAndRejectsInvalidCombinations",
        "test_RiskManagerFormulaBranchesRoundUpAndHandleZero",
    ].map((testName) => [riskManagerHarnessGovernanceFile, "RiskManagerHarnessGovernanceParityTest", testName]),
    ...[
        "test_RiskManagerLifecycleRejectsDirectPausedAndMissingIntentCalls",
        "test_RiskManagerCreatesUnbondedStakeBackedAndDeferredModes",
        "test_RiskManagerAdmissionRejectsDuplicateTokenMismatchInsufficientAndExiting",
        "test_RiskManagerAdmissionRequiresManagerAsIntentGuardian",
        "test_RiskManagerExtensionRejectsEscrowTimestampMismatch",
        "test_RiskManagerReconcilesCancellationAtOriginalTimestamp",
    ].map((testName) => [riskManagerHarnessAdmissionFile, "RiskManagerHarnessAdmissionParityTest", testName]),
    ...[
        "test_RiskSettlementRejectsDirectAndInvalidContexts",
        "test_StakeBackedSettlementUsesGrossCoverageAndConsumesNoFunds",
        "test_DeferredSettlementPullsGrossAndAccountsFees",
        "test_DeferredAdmissionSnapshotsPayoutRecipientAsStakeOwner",
        "test_DeferredAdmissionRejectsExitingPayoutRecipient",
        "test_UnbondedSettlementReleasesPositionAndRejectsRepeat",
        "test_StakeCoverageMaturesAtHalfOpenDeadlineAndEmptyBatchRejects",
    ].map((testName) => [riskManagerHarnessSettlementFile, "RiskManagerHarnessSettlementParityTest", testName]),
];
if (riskManagerCoverageSourceTests.length !== 18 || riskManagerCoverageDestinations.length !== 18) {
    throw new Error(
        `RiskManager coverage mapping count mismatch: ${riskManagerCoverageSourceTests.length} source / ${riskManagerCoverageDestinations.length} translated destinations`
    );
}

function riskManagerCoverageDestination(test) {
    if (test.sourceFile !== riskManagerCoverageSource) return "";
    const sourceIndex = riskManagerCoverageSourceTests.findIndex((sourceTest) => sourceTest.id === test.id);
    if (sourceIndex < 0) return "";
    const [file, contractName, testName] = riskManagerCoverageDestinations[sourceIndex];
    return `${file}:${contractName}::${testName}`;
}
...
const riskManagerDestinations = [
    ...
    ...[
        "test_FreeInitialExpiryAdmitsNonChargebackableIntentWithoutStake",
        "test_FreeInitialExpiryAllowsAnotherIntentAfterCancellation",
        "test_FreeInitialExpiryCancellationChargesNoStake",
        "test_FreeInitialExpiryPruningAfterBasePeriodChargesNoStake",
        "test_FreeInitialExpirySnapshotsIntentWithoutExtensionCollateral",
        "test_FreeInitialExpirySupportsConcurrentDelegatedTakers",
        "test_OrchestratorV3ExposesNoRelayerOrGlobalMultipleIntentPrivilege",
        "test_AdmissionUsesDelegatedSafeAsSharedStakeOwner",
        "test_AdmissionAllowsMultipleIntentsWithinSharedFreeStake",
        "test_AdmissionRejectsOnlyWhenPortfolioExceedsFreeStake",
        "test_AdmissionSnapshotsPlatformPolicyBeforeGovernanceChange",
    ].map((testName) => [riskManagerAdmissionFile, "RiskManagerAdmissionParityTest", testName]),
    ...[
        "test_ExtensionUsesTakerStakeAndChargesElapsedTimeOnCancellation",
        "test_ExtensionChargesSameElapsedCurveOnFulfillment",
        "test_ExtensionCollateralRemainsSeparateFromChargebackCoverage",
        "test_DelegatedStakeOwnerExtendsWithoutTransferringOwnership",
        "test_ExtensionResolvesDelegatedOwnerAddedAfterAdmission",
        "test_ThirdPartyCannotLockTakerStakeForExtension",
        "test_RevocationBlocksTakerTopupsButPreservesOriginalOwnerControl",
        "test_ExtensionCannotReviveExpiredIntent",
    ].map((testName) => [riskManagerExtensionLifecycleFile, "RiskManagerExtensionLifecycleParityTest", testName]),
    ...[
        "test_ExtensionEnforcesFiveDayLifetimeBeforeReservingMoreStake",
        "test_ExtensionTopupRejectsReservationsPause",
        "test_FirstExtensionRejectsPauseForTakerAndDelegatedOwner",
        "test_ExtensionTopupRejectsStakeOwnerExit",
        "test_ExtensionUsesCumulativeRoundingAcrossRepeatedSteps",
        "test_DelegatedOwnerCanExecuteZeroIncrementRoundingStep",
        "test_ZeroIncrementExtensionStillEnforcesPauseAndExitGates",
...
const v2CoreDeploymentMappings = new Map([
    ["test/deploy/10_acrossBridgeHook.spec.ts", [acrossBridgeHookDeploymentFile, "AcrossBridgeHookDeploymentParityTest", [
        "test_AcrossBridgeHookDeploymentSetsConstructorParameters",
        "test_AcrossBridgeHookDeploymentSetsOwner",
        "test_AcrossBridgeHookDeploymentWhitelistsHook",
    ]]],
    ["test/deploy/14_v2System.spec.ts", [v2SystemDeploymentFile, "V2SystemDeploymentParityTest", [
        "test_OrchestratorRegistryDeploymentSetsOwner",
        "test_OrchestratorRegistryRegistersV1",
        "test_OrchestratorRegistryRegistersV2",
        "test_EscrowV2DeploymentSetsOwner",
        "test_EscrowV2DeploymentSetsChainId",
        "test_EscrowV2DeploymentWiresOrchestratorRegistry",
        "test_EscrowV2DeploymentWiresPaymentVerifierRegistry",
        "test_EscrowV2DeploymentSetsDustRecipient",
        "test_EscrowV2DeploymentSetsDustThreshold",
        "test_EscrowV2DeploymentSetsMaximumIntents",
        "test_EscrowV2DeploymentSetsIntentExpiration",
        "test_EscrowV2DeploymentWhitelistsEscrow",
        "test_OrchestratorV2DeploymentSetsOwner",
        "test_OrchestratorV2DeploymentSetsChainId",
        "test_OrchestratorV2DeploymentWiresEscrowRegistry",
        "test_OrchestratorV2DeploymentWiresPaymentVerifierRegistry",
        "test_OrchestratorV2DeploymentOmitsRetiredRelayerAndGlobalIntentControls",
        "test_OrchestratorV2DeploymentSetsProtocolFee",
        "test_OrchestratorV2DeploymentSetsProtocolFeeRecipient",
        "test_UnifiedPaymentVerifierV2DeploymentSetsOwner",
        "test_UnifiedPaymentVerifierV2DeploymentWiresOrchestratorRegistry",
        "test_UnifiedPaymentVerifierV2DeploymentWiresNullifierRegistry",
        "test_RetiredV2VerifierLegacyNullifierPermissionIsRevoked",
    ]]],
]);
for (const [sourceFile, [, , destinations]] of v2CoreDeploymentMappings) {
    const sourceCount = inventory.tests.filter((test) => test.sourceFile === sourceFile).length;
    if (sourceCount !== destinations.length) {
        throw new Error(`${sourceFile} mapping count mismatch: ${sourceCount} source / ${destinations.length} translated destinations`);
    }
...
function v2CoreDeploymentDestination(test) {
    const mapping = v2CoreDeploymentMappings.get(test.sourceFile);
    if (!mapping) return "";
    const [file, contractName, destinations] = mapping;
    const sourceTests = inventory.tests.filter((sourceTest) => sourceTest.sourceFile === test.sourceFile);
    const sourceIndex = sourceTests.findIndex((sourceTest) => sourceTest.id === test.id);
...
const peripheryDeploymentMappings = new Map([
    ["test/deploy/27_removeLegacyZellePaymentMethods.spec.ts", [legacyZelleRemovalDeploymentFile, "LegacyZelleRemovalDeploymentParityTest", [
        "test_RemovesLegacyRegistrationsPreservesWithdrawalAndGenericZelle",
        "test_QueuesExactRegistryFirstSafeOwnedRemovalBatch",
        "test_DeployedStateKeepsGenericActiveAndLegacyUnsupported",
    ]]],
...
const rows = inventory.tests.map((test) => {
    ...
    if (foundryDestination.startsWith(legacyZelleRemovalDeploymentFile)) evidence = "Legacy-Zelle removal deployment parity: 3 passed independently and together, 0 failed, 0 skipped; exact registry-first Safe batch, legacy withdrawal continuity, generic payment fulfillment, and final deployed routing state";
