export default {
  ...
  "contracts": {
    ...
    "BoundedCall": {
      "address": "0x8C2A1827b85dc1769768748bFa05D3A1e0d9D8C8",
      "abi": [
        {
          "inputs": [
            {
    ...
    "DeferredPayoutHook": {
      "address": "0xeBc480E0829d10f9652d87b09ee72238d0Ed6914",
      "abi": [
        {
          "inputs": [
            {
            ...
            {
              "internalType": "contract IRiskTierManager",
              "name": "_riskTierManager",
              "type": "address"
            },
            {
              "internalType": "contract IOrchestratorRegistry",
    ...
    "OrchestratorV3": {
      "address": "0xD644D3Aa920785272f6cFE4828AE30208D9C3891",
      "abi": [
        {
          "inputs": [
            {
    ...
    "PostIntentHookExecutor": {
      "address": "0xe4394b9be330Ef81FC2EDE3185eeA1a985C43bdb",
      "abi": []
    },
    ...
    "RiskTierManager": {
      "address": "0xe9F33E540700B3F3092F4ed2ba6F4635FC7AB6Ee",
      "abi": [
        {
          "inputs": [
            {
            ...
            },
            {
              ...
              "name": "_concurrencyLimits",
              "type": "uint256[5]"
            },
            {
              "internalType": "uint64",
              "name": "_maxIntentLifetime",
              "type": "uint64"
            },
            {
              "internalType": "uint64",
              "name": "_settlementBuffer",
              "type": "uint64"
            }
          ],
          "stateMutability": "nonpayable",
        ...
        },
        {
          ...
          "name": "ConcurrentIntentLimitReached",
          "type": "error"
        },
        {
          "inputs": [
        ...
        },
        {
          "inputs": [
            {
              "internalType": "enum IRiskTierManager.Tier",
              "name": "tier",
              "type": "uint8"
            }
          ],
        ...
        },
        {
          "inputs": [
            ...
            {
              "internalType": "enum IRiskTierManager.RiskMode",
              "name": "mode",
              "type": "uint8"
            }
          ],
        ...
        },
        {
          "inputs": [
            ...
            {
              "internalType": "enum IRiskTierManager.PositionStatus",
              "name": "status",
              "type": "uint8"
            }
          ],
          ...
          "outputs": [
            {
              ...
              "internalType": "struct IRiskTierManager.PlatformRiskConfig",
              "name": "",
              "type": "tuple"
            }
          ],
          ...
          "outputs": [
            {
              ...
              "internalType": "struct IRiskTierManager.RiskPosition",
              "name": "",
              "type": "tuple"
            }
          ],
          ...
          "inputs": [
            {
              ...
              "internalType": "struct IRiskTierManager.ChargebackAttestation",
              "name": "_attestation",
              "type": "tuple"
            }
          ],
    ...
    "StakeVault": {
      "address": "0x29d08D4e53333D0523Ab63cc185f28a70a1A2f36",
      "abi": [
        {
          "inputs": [
            {
        ...
        },
        {
          ...
          "name": "IntentCapacityAlreadyReserved",
          "type": "error"
        },
        {
          "inputs": [
          ...
          "outputs": [
            {
              ...
              "internalType": "struct IStakeVault.IntentCapacity",
              "name": "",
              "type": "tuple"
            }
          ],
