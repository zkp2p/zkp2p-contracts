...
- `AcrossSwapBridgeHook` executes Across swap-and-bridge directly through `swapAndBridge` with the committed destination params.
- It includes the same fallback-on-failure behavior for on-chain resilience.
